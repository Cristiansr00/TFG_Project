...
def generateFolderStructure(zip_path:str, k_fold_value:int) -> str:
    ...
    unmarked_dir = f'{CURRENT_DIRECTORY}/{DATASET_FOLDER}/50 Images/Unmarked'
    labels_dir = f'{CURRENT_DIRECTORY}/{DATASET_FOLDER}/50 Images/Labels'    
    ...
    dest_path = Path(Path(f"{CURRENT_DIRECTORY}/{DATASET_FOLDER}") / f"{TODAY}_{k_fold_value}-Fold_Cross-val")
